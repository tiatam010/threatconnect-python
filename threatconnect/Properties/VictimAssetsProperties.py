...
class VictimAssetsProperties(VictimsProperties):
    ...
    def __init__(self):
        """ """
        super(VictimAssetsProperties, self).__init__()
        ...
        # update data methods
        self._data_methods.pop('nationality')
        self._data_methods.pop('org')
        self._data_methods.pop('suborg')
        self._data_methods.pop('workLocation')
        self._data_methods['type'] = {
            'get': 'get_type',
            'set': 'set_type',
            'var': '_type'}
