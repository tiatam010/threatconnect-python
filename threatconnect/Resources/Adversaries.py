""" standard """
import types
from threatconnect.Config import ResourceProperties
...
class Adversaries(Resource):
    ...
    # def add_resource(self, adversary):
    #     """ """
    #
    #     # set properties
    ...
    #
    #     # set indicator
    #     self._resource_object.set_name(adversary)
    #
    ...
    #             self.add(obj)
    #     else:
    #         print('Validation of adversary failed.')
