...
def main():
    ...
    for res in resources:
        ...
        if res.get_id() == 747243:
            #
            # update resource if required
            #
            res.set_name('Loop Update Threat Sample %s' % randy)
    ...
    resource = resources.update(752679)
    resource.set_name('Manual Update Threat Sample %s' % randy)
