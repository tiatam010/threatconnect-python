...
def main():
    ...
    for res in resources:
        ...
        if res.get_id() == 747246:
            ...
            #
            res.set_name('Loop Update Incident Sample %s' % randy)
            res.set_event_date('2015-03-%sT00:00:00Z' % randint(1, 30))
    ...
    resource.set_event_date('2015-03-%sT00:00:00Z' % randint(1, 30))
